...
WITH monthly_sale as(
    select year(sale_date) as year,
     ...
     select *,
         ...
         from monthly_sale)
select 
year,month,avg_sale from ranked_sale where rnk=1;
```
...
```sql
select category,count(distinct customer_id) as cnt_customer from retail_sales group by 1;
```
...
## Author - Shahrin binte ali

This project is part of my portfolio, showcasing the SQL skills essential for data analyst roles. If you have any questions, feedback, or would like to collaborate, feel free to get in touch!


- **LinkedIn**: www.linkedin.com/in/shahrin-binte-ali-mouly-537a85149
